...
@register_task("conversational_nlu")
class ConversationalNLUTask(LegacyFairseqTask):
    """
    Conversational NLU task.
    Predicts pointer and intent/slot tag.
    ...
    def build_model(self, args):
        ...
        # Use a custom RoBERTa model here
